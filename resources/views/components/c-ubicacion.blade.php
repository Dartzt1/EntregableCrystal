            ...
            <div class="row g-3 justify-content-center g-lg-0">
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="footer-top-item lab-item">
                        <div class="lab-inner">
                            <div class="lab-thumb" >
                                <img src="http://localhost/EntregableCrystalPass\public\assets/images/footer/footer-top/celular.png" width="35px" alt="Phone-icon">
                            </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="footer-top-item lab-item">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="http://localhost/EntregableCrystalPass\public\assets/images/footer/footer-top/correo.png" width="35px" alt="email-icon">
                            </div>
                            <div class="lab-content">
                                <span>Correo: crystalpasscor@gmail.com</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="footer-top-item lab-item">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="http://localhost/EntregableCrystalPass\public\assets/images/footer/footer-top/ubicacion.png" width="35px" alt="location-icon">
                            </div>
                            <div class="lab-content">
